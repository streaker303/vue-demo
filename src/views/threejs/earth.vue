...
export default {
    ...
    mounted() {
        ...
        function initObject() {
            ...
            // 光环
            globeTextureLoader.load('/img/halo.png', function (texture) {
            ...
            // 小地球
            globeTextureLoader.load('/img/smallEarth.png', function (texture) {
            ...
            // 地球
            globeTextureLoader.load('/img/earth2.jpg', function (texture) {
